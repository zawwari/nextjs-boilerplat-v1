...
export default function Home() {
  ...
  return (
    <div>
      <header className="flex mb-8 flex-wrap sm:justify-start  sm:flex-nowrap z-50 w-full  border-b border-gray-200/5 text-sm py-3 sm:py-0 ">
          ...
          <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7">
              ...
              {!user?.user?.email ? <Authentication>
                <button className="flex items-center gap-x-2 px-4 py-3 font-medium  sm:border-s    text-white border-[#6c53c3] border rounded-lg  dark:text-neutral-400  cursor-pointer" >
      ...
      gap-x-3 text-center bg-gradient-to-tl from-blue-600
       to-violet-600 cursor-pointer hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:focus:ring-offset-gray-800"
              href="/app">
              Get started
